...
object camion {
    ...
    method primeraCargaQueTieneNivelDePeligrosidadIgualA(peligrosidad) = cosasCargadas.findOrDefault(
        {c => c.nivelDePeligrosidad() == peligrosidad}, "No hay cosa")


    method cosasQueSuperanPeligrosidad(peligrosidad) = cosasCargadas.filter({c => c.nivelDePeligrosidad() >
         peligrosidad})


    method cosasCargadasQueSuperanPeligrosidadDe(cosa) = self.cosasCargadasQueSuperanPeligrosidadDe(
        cosa.nivelDePeligrosidad())
